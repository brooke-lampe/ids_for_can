...
import com.example.ids_for_can.ConfigActivity;
import com.example.ids_for_can.MainActivity;
import com.example.ids_for_can.connectivity.ObdCommandJob.ObdCommandJobState;
...
public class ObdGatewayService extends AbstractGatewayService {
     ...
     */
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_starting), R.drawable.scribble, true, true, false);
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_started), R.drawable.scribble, true, true, false);
        }
    }
     ...
     */
        ...
        queueJob(new ObdCommandJob(new TimeoutCommand(60)));
